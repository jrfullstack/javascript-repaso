...
import { asyncAwayNoSecuencialComponent } from './src/concepts/07-async-await-no-secuenciales';
import { forAwaitComponent } from './src/concepts/08-for-await';
import { generatorFunctionsComponent } from './src/concepts/09-funciones-generadoras';
import { generatorAsyncComponent } from './src/concepts/10-fun-gen-async';
...
// asyncAwayNoSecuencialComponent(element);
